...
AS $$
DECLARE
  project_url TEXT := 'https://uxumbcriokicqvymaebj.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InV4dW1iY3Jpb2tpY3F2eW1hZWJqIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcyMDUxODQ2MSwiZXhwIjoyMDM2MDk0NDYxfQ.xPuTeR4Sf84AwUAizAF1CNvMTu_MM511RChULC-L_PE'; -- full access needed for http request to storage
