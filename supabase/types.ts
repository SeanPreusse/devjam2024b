  ...
  public: {
    Tables: {
      ...
      profiles: {
        ...
        Relationships: [
          {
            foreignKeyName: "profiles_home_workspace_fkey"
            columns: ["home_workspace"]
            isOneToOne: false
            referencedRelation: "workspaces"
            referencedColumns: ["id"]
          },
      ...
      user_invites: {
        Row: {
          ...
          id: number
          invited_by: string
          role: Database["public"]["Enums"]["workspaceroles"] | null
          workspace_id: string
        }
        Insert: {
          code?: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "user_invites_invited_by_fkey1"
            columns: ["invited_by"]
            isOneToOne: false
      ...
      users_on_team: {
        ...
        Relationships: [
          {
            foreignKeyName: "users_on_team_user_id_fkey1"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["user_id"]
          ...
          {
            foreignKeyName: "users_on_team_workspace_id_fkey"
            columns: ["workspace_id"]
            isOneToOne: false
            referencedRelation: "workspaces"
            referencedColumns: ["id"]
    ...
    Enums: {
      workspaceroles: "member" | "owner" | "guest"
    }
    CompositeTypes: {
      [_ in never]: never
    }
