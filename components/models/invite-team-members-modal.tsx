...
import { inviteTeamMembersAction } from "@/components/models/invite-team-member-action";
import {
  InviteTeamMembersFormValues,
  inviteTeamMembersSchema,
} from "@/components/utility/action-schems";
...
export function InviteTeamMembersModal({ onOpenChange, isOpen, currentUser }) {
  const { toast } = useToast();

  const inviteMembers = useAction(() => inviteTeamMembersAction(currentUser), { // Modified to pass userId to the action
    onSuccess: () => {
      onOpenChange(false);
